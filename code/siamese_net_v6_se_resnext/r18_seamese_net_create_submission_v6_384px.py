...
def create_submission(thr):
    out_path = SUBM_PATH + 'siamese_net_v6_seresnext50_384px_THR_{}.csv'.format(thr)
    out = open(out_path, 'w')
    out.write('Image,Id\n')
...
'''
THR 0.70: 'new_whale', 2220 Unique classes: 3979
THR 0.75: 'new_whale', 2274 Unique classes: 3952
THR 0.80: 'new_whale', 2326 Unique classes: 3918
THR 0.85: 'new_whale', 2421 Unique classes: 3894
'''