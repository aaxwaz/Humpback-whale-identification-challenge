...
def make_steps_fast(step, ampl, verbose=2):
    ...
    history = model.fit_generator(
        TrainingDataFast(score_list, steps=step, batch_size=4),
...
if __name__ == '__main__':
    ...
    version = 'warmstart'
    pretrained_weights = ''
    # pretrained_weights = MODELS_PATH + '{}/seresnext50_224px_warmstart_final_0.869127.model'.format(saved_folder)

    # Get best model from previous run
    best_models = glob.glob(MODELS_PATH + '{}/seresnext50_224px_*.model'.format(saved_folder))
    best_score = -1.0
    best_weights = ''
...
'''
TB 1: 0.749859
Valid score: 0.839784
Valid score: 0.852941
Valid score: 0.853931
TB 1: Valid score: 0.866189
TB 2: Valid score: 0.877998
Valid score: 0.882366
TB 3: Valid score: 0.880989
Valid score: 0.888267
TB 4: Valid score: 0.878117
TB 5: Valid score: 0.887145
